...
<html>
	<head>
		...
		<link rel="stylesheet" href="{{ asset ('index/assets/css/main.css') }}" />
	</head>
	<body>
		...
		<!-- Header -->
			<header id="header">
				...
				<nav class="right">
					<a href="{{ route ('home') }}" class="button alt">Log in</a>
				</nav>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="content">
					<h1>Siap Bayar Zakat Sekarang ?</h1>
					<p>Bersihkan harta dengan zakat yang mudah dan cepat,<br />  kapan saja ke lembaga dan program zakat terpercaya via AyoZakat.</p>
					<ul class="actions">
						<li><a href="#one" class="button scrolly">Zakat Sekarang</a></li>
					</ul>
				</div>
			</section>
			...
			<section id="one" class="wrapper">
				<div class="inner flex flex-3">
					...
					<div class="flex-item image fit round">
						<img src="{{ asset ('index/assets/images/pic01.jpg') }}" alt="" />
					</div>
		...
		<!-- Scripts -->
			...
			<script src="{{ asset ('index/assets/js/jquery.scrolly.min.js') }}"></script>
			<script src="{{ asset ('index/assets/js/skel.min.js') }}"></script>
			<script src="{{ asset ('index/assets/js/util.js') }}"></script>
